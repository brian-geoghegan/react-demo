...
function EnhancedTableHead(props) {
  const {
    classes, order, orderBy, onRequestSort, headings,
  } = props;
...
const createTableBody = (tableData, handler, classes) => tableData.map((rowData) => createTableBodyRow(rowData, handler, classes));
